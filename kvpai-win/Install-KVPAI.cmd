...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$ErrorActionPreference='Stop'; Invoke-WebRequest 'https://raw.githubusercontent.com/KelbyVP/app-releases/main/kvpai-win/KVPAI.cer' -OutFile \"$env:TEMP\KVPAI.cer\"; Import-Certificate -FilePath \"$env:TEMP\KVPAI.cer\" -CertStoreLocation Cert:\LocalMachine\TrustedPeople | Out-Null; Add-AppxPackage -AppInstallerFile 'https://raw.githubusercontent.com/KelbyVP/app-releases/main/kvpai-win/KVPAI.appinstaller'; Write-Host 'Done - KVPAI is installed and will auto-update on launch.'"
echo.
pause

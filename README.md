...
|-----|----------|--------|--------------|
| **KVP Stock Tracker** | Android | [`stocktracker/`](stocktracker/) | [APK](https://raw.githubusercontent.com/KelbyVP/app-releases/main/stocktracker/kvp-stock-tracker-arm64.apk) |
...
| **KVPAI** | Windows | [`kvpai/`](kvpai/) | [Install-KVPAI.cmd](https://github.com/KelbyVP/app-releases/blob/main/kvpai/Install-KVPAI.cmd) |
